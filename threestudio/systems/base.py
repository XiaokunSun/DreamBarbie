...
class BaseLift3DSystem(BaseSystem):
    ...
    class Config(BaseSystem.Config):
        ...
        renderer_RD_type: str = ""
        renderer_RD: dict = field(default_factory=dict)
        ...
        guidance_RD_StableDiffusion_type: str = ""
        guidance_RD_StableDiffusion: dict = field(default_factory=dict)

        guidance_RD_NormalDepth_type: str = ""
        guidance_RD_NormalDepth: dict = field(default_factory=dict)

        guidance_RD_Albedo_type: str = ""
        guidance_RD_Albedo: dict = field(default_factory=dict)
        ...
        prompt_processor_RD_StableDiffusion_type: str = ""
        prompt_processor_RD_StableDiffusion: dict = field(default_factory=dict)

        prompt_processor_RD_NormalDepth_type: str = ""
        prompt_processor_RD_NormalDepth: dict = field(default_factory=dict)

        prompt_processor_RD_Albedo_type: str = ""
        prompt_processor_RD_Albedo: dict = field(default_factory=dict)
